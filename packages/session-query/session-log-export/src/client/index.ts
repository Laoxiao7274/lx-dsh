...
/**
 * Provide the download controller and mount its modal into the Trajectory
 * toolbar's action seat — the export action lives where the session's full
 * record is inspected.
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.slots.inject('conversation.trajectory.action', () => ctx.slots.register({
    name: 'conversation.trajectory.action',
