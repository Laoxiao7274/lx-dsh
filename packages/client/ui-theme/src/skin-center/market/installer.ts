...
export function planDownload(kind: MarketKind, id: string, files: readonly unknown[]): DownloadPlanEntry[] {
...
async function fetchManifest(
  ...
  if (!Array.isArray(data.items)) throw new MarketInstallError('manifest', 'manifest shape invalid')
  return data
}
