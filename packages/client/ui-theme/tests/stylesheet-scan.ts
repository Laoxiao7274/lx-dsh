...
/**
 * Every CSS file shipped as package source, excluding build output, installed
 * dependencies, and the skin-center asset directories (third-party skin
 * content governed by its own css-safety pipeline at serve time, not by the
 * product style gates).
