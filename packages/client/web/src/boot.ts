...
import { applyHostEnvironment } from './host.ts'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      // Hosted-form-factor resolution comes first: the insets land as :root
      // custom properties before the boot page, plugin bundles, or app UI paint.
      applyHostEnvironment(globalThis)
