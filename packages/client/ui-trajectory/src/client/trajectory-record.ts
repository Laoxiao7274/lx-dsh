...
/**
 * Compact structural duration used by ledger metric tails: `12.4s`, `4m12s`.
 * @param seconds - Duration seconds.
 * @returns A tabular-friendly duration label.
 */
export function formatHeadDuration(seconds: number): string {
