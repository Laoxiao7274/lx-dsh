...
export const zh = {
  ...
  'toolbar.modes': '时间轴模式',
  'toolbar.modeEqual': '等宽',
  'toolbar.modeDuration': '时长',
  'toolbar.modeActual': '实时',
  'toolbar.turns': '轮次',
...
export const en: Record<TrajectoryKey, string> = {
  ...
  'toolbar.modes': 'Timeline mode',
  'toolbar.modeEqual': 'Equal',
  'toolbar.modeDuration': 'Duration',
  'toolbar.modeActual': 'Actual',
  'toolbar.turns': 'Turns',
  ...
  'row.failed': 'Failed',
  'row.turnAria': 'Turn',
  'row.stepAria': 'Request',
  'row.loadOlder': 'Load earlier history',
  'row.loading': 'Loading…',
