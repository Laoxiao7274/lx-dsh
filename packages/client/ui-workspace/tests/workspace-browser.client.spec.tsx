...
describe('WorkspaceBrowser', () => {
  ...
  it('rail add-workspace raises a two-action menu: directory add and remote connect', () => {
    const expandSidebar = vi.fn()
    ...
    // The remote-connect entry joins the directory add, so the gesture opens
    // the menu instead of collapsing into the single add action; existing
