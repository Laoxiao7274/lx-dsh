...
export function ConversationRoot({
  ...
  return (
    <div ref={rootResizeRef} className={css.root} data-phase={phase}>
      ...
      {/* No Session open: the hero carries the utilities strip at the same
          top-right edge, so the desktop shell's window chrome never disappears
          between the hero and a Session. The band spans the full top edge and
          doubles as the window drag region (the shell's chrome claims it). */}
      {sessionId === undefined && (
        <div className={css.heroUtilities} data-hero-utilities="">
