...
describe('SettingsPanel close paths', () => {
  // The LX-DSH SettingsRoot keeps the pre-refactor shell: closing does not
  // restore the trigger focus (the upstream focus-return refinement is not
  // part of our fork), so these paths assert the closing itself.
