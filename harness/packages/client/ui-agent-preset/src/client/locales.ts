...
export type AgentPresetSettingsKey =
  ...
  | 'presetQuickAnswersName' | 'presetQuickAnswersDescription'
  | 'presetStandardName' | 'presetStandardDescription'
  | 'presetPtcName' | 'presetPtcDescription'
  | 'presetMinimalName' | 'presetMinimalDescription'
  | 'presetCordisName' | 'presetCordisDescription'
  | 'presetLxcodeName' | 'presetLxcodeDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  view: 'View',
  presetQuickAnswersName: 'Quick answers',
  presetQuickAnswersDescription:
    'General Q&A unrelated to any project: every answer is grounded in a web search with sources cited.',
  ...
  presetLxcodeName: 'LxCode',
  presetLxcodeDescription:
    'LxCode — your custom coding agent. Standard mode plus cross-session memory: checkpoints, project memory, and session search.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  setDefault: '设为默认',
  view: '查看',
  presetQuickAnswersName: '快问快答',
  presetQuickAnswersDescription: '与项目无关的通用问答：每次回答都先联网搜索并附来源。',
  ...
  presetLxcodeName: 'LxCode',
  presetLxcodeDescription: 'LxCode —— 属于你的自定义编码 Agent。基于标准模式，带跨会话记忆与检查点、项目记忆检索。',
  duplicate: '复制',
