...
export const zh = {
  ...
  'rewind': '撤回此消息',
  'rewind.unavailable': '已压缩会话中无法撤回',
  'rewind.confirmTitle': '撤回此消息',
  'rewind.confirmMessage': '这将撤回此消息及其之后的所有内容。该操作无法撤销，确定继续吗？',
  'rewind.confirm': '撤回',
  'rewind.cancel': '取消',
...
export const en = {
  ...
  'rewind.unavailable': 'Cannot rewind in a compacted session',
  ...
  'row.running': 'Running',
  'row.thoughtFor': 'Thought for {duration}',
  'row.failed': 'Failed',
