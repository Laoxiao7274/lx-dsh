...
export interface AssistantMarkdownProps {
  ...
  /** Completed thinking duration for the reasoning row; absent while running. */
...
export const AssistantMarkdown = memo(function AssistantMarkdown({
  blocks, streaming, interrupted, thinkingMs, renderMessageImages,
    ...
    switch (block.kind) {
      ...
      case 'reasoning':
        rendered.push(
          ...
          >
            <ReasoningRow text={block.text} running={streaming && i === last} thinkingMs={thinkingMs} t={t} />
          </ProcessReasoning>,
        )
        break
      case 'image': {
