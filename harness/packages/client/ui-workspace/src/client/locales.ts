...
export const zh = {
  ...
  'time.years': '{n}年',
  'time.ago': '{t}前',
  'remote.connect': '连接远程后端…',
  'remote.title': '连接远程后端',
  'remote.desc': '保存一个远程 dsh 后端的地址，点击即可在浏览器里直接打开它的界面。',
  'remote.name': '名称',
  'remote.name.placeholder': '例如：公司主机',
  'remote.address': '地址（IP:端口）',
  'remote.address.placeholder': '例如：192.168.1.5:3080',
  'remote.token': '访问令牌（可选）',
  'remote.token.placeholder': '目标后端“外网访问”设置里复制的令牌',
  'remote.invalid': '地址无法解析；请填写 IP 或域名，可带端口。',
  'remote.save': '保存并打开',
  'remote.open': '打开远程工作区',
  'remote.remove': '移除此连接',
  'remote.empty': '还没有保存的远程连接。',
...
export const en = {
  ...
  'time.years': '{n}y',
  'time.ago': '{t} ago',
  'remote.connect': 'Connect to a remote backend…',
  'remote.title': 'Connect to a remote backend',
  'remote.desc': 'Save a remote dsh backend address; clicking it opens that backend’s own UI in your browser.',
  'remote.name': 'Name',
  'remote.name.placeholder': 'e.g. Office desktop',
  'remote.address': 'Address (IP:port)',
  'remote.address.placeholder': 'e.g. 192.168.1.5:3080',
  'remote.token': 'Access token (optional)',
  'remote.token.placeholder': 'Token copied from the target backend’s remote-access settings',
  'remote.invalid': 'Could not parse the address; enter an IP or hostname, optionally with a port.',
  'remote.save': 'Save and open',
  'remote.open': 'Open remote workspace',
  'remote.remove': 'Remove this connection',
  'remote.empty': 'No saved remote connections yet.',
